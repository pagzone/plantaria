  ...
  return (
    <div className="md:mx-[75px] flex flex-col gap-y-4 max-md:px-4">
      ...
      <div className="flex flex-col gap-y-4">
        ...
        <div className="border border-gray-200 shadow-lg md:h-64 h-44 rounded-xl bg-white flex items-center gap-x-6 px-6 py-4">
          <div className="relative">
            <Profile userProfile={preview || userProfile} 
          ...
          <div className="flex flex-col justify-center">
            <span className="text-xl md:text-2xl font-bold">Gian Carlo Villar</span>
            <span className="text-slate-600 max-md:text-sm">San Jose Del Monte, Bulacan</span>
          </div>
        </div>

        <div className="relative border border-gray-200 shadow-lg md:h-64 h-56 rounded-xl p-6 bg-white">
          <h1 className="text-xl md:text-2xl font-bold text-lime-700 mb-6">User Information</h1>

          <div className="grid grid-cols-2 gap-x-8 items-center">
            <div className="flex flex-col gap-y-5">
              <div className="flex flex-col">
                <span className="text-gray-500 text-sm">Full Name</span>
                <span className="text-sm md:text-lg font-medium text-gray-800 max-md:truncate">John Doe</span>
              </div>
              <div className="flex flex-col">
                <span className="text-gray-500 text-sm">Email Address</span>
                <span className="text-sm md:text-lg font-medium text-gray-800 max-md:truncate">Darvey234244@gmail.com</span>
              </div>
            </div>
