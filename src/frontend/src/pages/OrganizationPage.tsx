...
import { Edit, Link, Mail, Pencil, Phone, Save, UserRoundPen } from "lucide-react";
      ...
      <div className="flex flex-col gap-y-6 relative">
        ...
        <div className="h-52 flex flex-col items-center justify-center gap-y-2">
          <div className="relative">
            <Profile userProfile={preview || orgProfile} style="size-32 sm:size-40" />
        ...
        <div className="border h-auto sm:h-60 flex flex-col rounded-lg shadow bg-white px-6 py-4 w-full relative">
          ...
          <div className="grid grid-rows-3 grid-flow-col space-y-2 py-2">
            <div className="flex items-center space-x-2">
              <Mail className="w-5 h-5 text-gray-600" />
              <Input className="text-sm text-slate-800 border-none" value={"Pagzone@dev.gmail.com"} disabled={!isEditing} />
            </div>
            <div className="flex items-center space-x-2">
              <Link className="w-5 h-5 text-gray-600" />
              <Input className="text-sm text-slate-800 border-none" value={"Pagzone"} disabled={!isEditing} />
            </div>
            <div className="flex items-center space-x-2">
              <Phone className="w-5 h-5 text-gray-600" />
              <Input className="text-sm text-slate-800 border-none" value={"+935 785 0648"} disabled={!isEditing} />
            </div>
          </div>
